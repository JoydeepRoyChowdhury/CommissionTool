            ...
            <li class="dropdown">
                ...
                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>
                       					<li>
                                         <li><a href="#">Credit Rollup Rule</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Compensation</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#"><span class="label label-success">Employee Compensation Report</span></a>
                                        </li>
                                    </ul>
                                </li> 
                                <li class="dropdown">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>${sessionScope.employee}<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="/CommissionTool/logout"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul></nav></div>